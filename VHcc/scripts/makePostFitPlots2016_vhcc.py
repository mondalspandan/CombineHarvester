...
CHN_DICT_SR = {
    ...
    "Zmm": [["vhcc_Zmm_1_13TeV2016","Signal Region","2-lepton (#mu#mu), High V-p_{T}"],["vhcc_Zmm_2_13TeV2016","Signal Region","2-lepton (#mu#mu), Low V-p_{T}"]],
...
#                  ' --ratio_range 0.4,1.6 --empty_bin_error --channel=%(CHN)s --blind --x_blind_min 0.75 --x_blind_max 1.0 --x_title BDT --doVV True' \
                  ...
                  ' --channel_label "%(LABEL)s" --extralabel "%(EXTRALABEL)s" --ratio_justb' % vars()))

...
background_schemes = {
'Wen':[backgroundComp("Single top",["s_Top"],623),backgroundComp("VV+LF",["VVLF"], 866),backgroundComp("t#bar{t}",["TT"],633),backgroundComp("Z+udscg",["Zj_ll"],821),backgroundComp("Z+bl/cl",["Zj_blc"],830),backgroundComp("Z+b#bar{b}",["Zj_bbc"],829),backgroundComp("Z+c#bar{c}",["Zj_cc"],824),backgroundComp("W+udscg",["Wj_ll"],800),backgroundComp("W+bcl",["Wj_bl/bc"],801),backgroundComp("W+b#bar{b}",["Wj_bbc"],802),backgroundComp("W+c#bar{c}",["Wj_cc"],803),backgroundComp("VV+bb",["VVbb"],867),backgroundComp("VV+bb",["VVcc"],859),backgroundComp("ZHb#bar{b}",["ZH_hbb"],881),backgroundComp("WHb#bar{b}",["WH_hbb"],880)],
'Wmn':[backgroundComp("Single top",["s_Top"],623),backgroundComp("VV+LF",["VVLF"], 866),backgroundComp("t#bar{t}",["TT"],633),backgroundComp("Z+udscg",["Zj_ll"],821),backgroundComp("Z+bl/cl",["Zj_blc"],830),backgroundComp("Z+b#bar{b}",["Zj_bbc"],829),backgroundComp("Z+c#bar{c}",["Zj_cc"],824),backgroundComp("W+udscg",["Wj_ll"],800),backgroundComp("W+blc",["Wj_bl/bc"],801),backgroundComp("W+b#bar{b}",["Wj_bbc"],802),backgroundComp("W+c#bar{c}",["Wj_cc"],803),backgroundComp("VV+bb",["VVbb"],867),backgroundComp("VV+bb",["VVcc"],859),backgroundComp("ZHb#bar{b}",["ZH_hbb"],881),backgroundComp("WHb#bar{b}",["WH_hbb"],880)],
'Zee':[backgroundComp("Single top",["s_Top"],623),backgroundComp("VV+LF",["VVLF"], 866),backgroundComp("t#bar{t}",["TT"],633),backgroundComp("Z+udscg",["Zj_ll"],821),backgroundComp("Z+bl/cl",["Zj_blc"],830),backgroundComp("Z+b#bar{b}",["Zj_bbc"],829),backgroundComp("Z+c#bar{c}",["Zj_cc"],824),backgroundComp("VV+bb",["VVbb"],867),backgroundComp("VV+cc",["VVcc"],859),backgroundComp("ZHb#bar{b}",["ZH_hbb"],881),backgroundComp("ggZHb#bar{b}",["ggZH_hbb"],590)],
'Zmm':[backgroundComp("Single top",["s_Top"],623),backgroundComp("VV+LF",["VVLF"], 866),backgroundComp("t#bar{t}",["TT"],633),backgroundComp("Z+udscg",["Zj_ll"],821),backgroundComp("Z+bl/cl",["Zj_blc"],830),backgroundComp("Z+b#bar{b}",["Zj_bbc"],829),backgroundComp("Z+c#bar{c}",["Zj_cc"],824),backgroundComp("VV+bb",["VVbb"],867),backgroundComp("VV+cc",["VVcc"],859),backgroundComp("ZHb#bar{b}",["ZH_hbb"],881),backgroundComp("ggZHb#bar{b}",["ggZH_hbb"],590)],#,backgroundComp("ZHc#bar{c}",["ZH_hcc"],633),backgroundComp("ggZHc#bar{c}",["ggZH_hcc"],801)],

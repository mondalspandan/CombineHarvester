...
parser.add_argument('--lumi', default='137.6 fb^{-1} (13 TeV)',help='Lumi label')
...
bkghist.SetFillColor(ROOT.kGray)
#bkghist.SetFillColor(ROOT.kGray+1)
#bkghist.SetFillColor(ROOT.kOrange-3)
#bkghist.SetFillColor(ROOT.kAzure-4)
#bkghist.SetFillColor(ROOT.kBlue-9)
#bkghist.SetFillColor(ROOT.kBlue-10)
...
legend.AddEntry(sighist, "VZ,Z#rightarrowc#bar{c}","f")
...
latex.DrawLatex(x_pos,args.VH_label_ypos,"VZ, Z#rightarrowc#bar{c}")

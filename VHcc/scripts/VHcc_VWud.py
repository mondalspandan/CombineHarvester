...
bkg_procs = {
  'Wen' : ['WH_hcc','ZH_hcc','WH_hbb','ZH_hbb','s_Top','TT','Wj_ll','Wj_bj','Wj_cj','Zj_ll','Zj_bj','Zj_cj','VWother','VVother','VZcc'],
  'Wmn' : ['WH_hcc','ZH_hcc','WH_hbb','ZH_hbb','s_Top','TT','Wj_ll','Wj_bj','Wj_cj','Zj_ll','Zj_bj','Zj_cj','VWother','VVother','VZcc'],
  'Zmm' : ['ZH_hcc','ggZH_hcc','ZH_hbb','ggZH_hbb','s_Top','TT','Zj_ll','Zj_bj','Zj_cj','VWother','VVother','VZcc'],
  'Zee' : ['ZH_hcc','ggZH_hcc','ZH_hbb','ggZH_hbb','s_Top','TT','Zj_ll','Zj_bj','Zj_cj','VWother','VVother','VZcc'],
...
#  cb.cp().channel(['Wen','Wmn']).process(['Wj_cj','Wj_bj','Wj_ll']).RenameSystematic(cb,'CMS_PostCTagWeight_13TeV_2016','CMS_PostCTagWeight_WJets_13TeV_2016')
  cb.cp().channel(['Wen','Wmn']).bin_id([1,3,5,7,9,11,13]).process(['Zj_cj']).RenameSystematic(cb,'CMS_PostCTagWeight_13TeV_2016','CMS_PostCTagWeight_Zc_High_13TeV_2016')
  cb.cp().channel(['Wen','Wmn']).bin_id([1,3,5,7,9,11,13]).process(['Zj_bj']).RenameSystematic(cb,'CMS_PostCTagWeight_13TeV_2016','CMS_PostCTagWeight_Zb_High_13TeV_2016')
  cb.cp().channel(['Wen','Wmn']).bin_id([1,3,5,7,9,11,13]).process(['Zj_ll']).RenameSystematic(cb,'CMS_PostCTagWeight_13TeV_2016','CMS_PostCTagWeight_Zl_High_13TeV_2016')
...
#  cb.cp().channel(['Wen','Wmn']).process(['Wj_cj','Wj_bj','Wj_ll']).RenameSystematic(cb,'CMS_PostCTagWeight_13TeV_2017','CMS_PostCTagWeight_WJets_13TeV_2017')
  cb.cp().channel(['Wen','Wmn']).bin_id([1,3,5,7,9,11,13]).process(['Zj_cj']).RenameSystematic(cb,'CMS_PostCTagWeight_13TeV_2017','CMS_PostCTagWeight_Zc_High_13TeV_2017')
  cb.cp().channel(['Wen','Wmn']).bin_id([1,3,5,7,9,11,13]).process(['Zj_bj']).RenameSystematic(cb,'CMS_PostCTagWeight_13TeV_2017','CMS_PostCTagWeight_Zb_High_13TeV_2017')
  cb.cp().channel(['Wen','Wmn']).bin_id([1,3,5,7,9,11,13]).process(['Zj_ll']).RenameSystematic(cb,'CMS_PostCTagWeight_13TeV_2017','CMS_PostCTagWeight_Zl_High_13TeV_2017')
...
#  cb.cp().channel(['Wen','Wmn']).process(['Wj_cj','Wj_bj','Wj_ll']).RenameSystematic(cb,'CMS_PostCTagWeight_13TeV_2018','CMS_PostCTagWeight_WJets_13TeV_2018')
  cb.cp().channel(['Wen','Wmn']).bin_id([1,3,5,7,9,11,13]).process(['Zj_cj']).RenameSystematic(cb,'CMS_PostCTagWeight_13TeV_2018','CMS_PostCTagWeight_Zc_High_13TeV_2018')
  cb.cp().channel(['Wen','Wmn']).bin_id([1,3,5,7,9,11,13]).process(['Zj_bj']).RenameSystematic(cb,'CMS_PostCTagWeight_13TeV_2018','CMS_PostCTagWeight_Zb_High_13TeV_2018')
  cb.cp().channel(['Wen','Wmn']).bin_id([1,3,5,7,9,11,13]).process(['Zj_ll']).RenameSystematic(cb,'CMS_PostCTagWeight_13TeV_2018','CMS_PostCTagWeight_Zl_High_13TeV_2018')

...
#Luca       'CMS_vhcc_ST', 'lnN', ch.SystMap()(1.15)) 
...
#Luca   cb.cp().channel(['Wen','Wmn','Zmm','Zee']).process(['VVcc']).AddSyst(cb,
#Luca       'CMS_LHE_weights_scale_muR_VVcc','shape',ch.SystMap()(1.0))
#Luca 
#Luca   cb.cp().channel(['Wen','Wmn','Zmm','Zee']).process(['VVbb']).AddSyst(cb,
#Luca       'CMS_LHE_weights_scale_muR_VVbb','shape',ch.SystMap()(1.0))
